...
import 'package:mobileutp/models/item.dart';
import 'package:mobileutp/services/item.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _updateItem(Item item) async {
    try {
      await ItemService.updateItem(item.id, item.nama,
item.jumlah);
      await _fetchItems();
    } catch (e) {
      // print('Error creating item: $e');
...
: "");
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return delete
            ? AlertDialog(title: const Text("Hapus data"),
                content: const Text(
